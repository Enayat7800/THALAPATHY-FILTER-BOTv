...
MELCOW_VID = environ.get("MELCOW_VID", "https://graph.org/file/a816163e5d7153781e2b9.mp4")
...
URL = "https://filterse-bot.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://filterse-bot.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://filterse-bot.onrender.com/".format(FQDN)
else:
    URL = "https://filterse-bot.onrender.com/".format(FQDN)
